...
g4 = Graph.addVertex (Graph.addVertex (Graph.addVertex (Graph.addVertex (Graph.addVertex Graph.empty "a") "b") "c") "d") "e"
g5 = Graph.addEdge (Graph.addEdge (Graph.addEdge g4 ("a","b")) ("a","c")) ("b","c")
g6 = Graph.addEdge g5 ("d","e")
